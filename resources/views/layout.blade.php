...
<body>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <?php }else{?>
                                        <li><a href="{{URL::to('/check-login')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                <?php } ?>
                                ...
                                <?php } else{ ?>
                                    <li><a href="{{URL::to('/check-login')}}"><i class="fa fa-lock"></i>Login</a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    ...
                                    <?php }else{?>
                                       <li><a href="{{URL::to('/check-login')}}"> Checkout</a></li>
                                    <?php } ?>
    ...
    <!-- ******slider default of this template start*******
