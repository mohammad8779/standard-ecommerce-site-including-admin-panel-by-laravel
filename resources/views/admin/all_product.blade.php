						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<tr>
								...
								<td class="center"><img src="{{$v_product->product_image}}" width="80px" height="80px"/></td>
								...
								<td class="center">
									...
									<a onClick ="return confirm('Are you sure to delete?')" class="btn btn-danger" href="{{URL::to('/delete-product',$v_product->product_id)}}">
